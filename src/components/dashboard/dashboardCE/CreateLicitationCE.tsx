...
import { Button, Country, Input } from '../../ui';
import { ProcessSaleConfirmation } from './ProcessSaleConfirmation';

const CreateLicitationCE = () => {
  ...
  return (
    <>
      <h2>Crear Licitación</h2>
      <p>En esta sección podrás crear una licitación.</p>

      <Formik
        initialValues={initialValues}
        validationSchema={processSaleSchema}
        onSubmit={onSubmit}>
...
export default CreateLicitationCE;
