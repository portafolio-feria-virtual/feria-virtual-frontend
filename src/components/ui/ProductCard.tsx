...
export default function ProductCard() {
  return (
    ...
    <div className="w-full max-w-sm bg-white rounded-lg shadow-md border">
        <img className="p-8 rounded-t-lg" src="https://www.65ymas.com/uploads/s1/23/51/17/naranjas-beneficios-contraindicaciones-y-recomendaciones-con-ellas.jpeg" alt="product image"/>
